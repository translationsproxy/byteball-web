			...
			<div class="row justify-content-md-center">
				<div class="col-md-12">
					...
					<div class="learn-more-block wiki_img" style="display:none;">
						<h3 class="section-heading section-heading--center section-heading--dark noto-sans-display-regular after-before-delete learn-more-desc">Wiki - отличный ресурс со статьями по широкому спектру возможностей платформы Byteball. However there is a lot of information and you may feel a bit lost! If you are totally new to Byteball we suggest reading the 4 articles listed below. If you read the 4 articles and want to learn more (which you will) then explore the wiki.</h3>
					</div>
