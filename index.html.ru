			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="row margin-zero">
						...
						<ul>
							<li>За каждые 160 BTC вы получите 1 GB (1 гигабайт = 1 миллион байтов),</li>
							<li>За каждые 10 GB получите дополнительные 1 GB.</li>
						</ul>
						<p>Чтобы подтвердить свой баланс, установите кошелёк Byteball напишите боту Transition Bot (вы найдёте его в магазине ботов Bot Store в кошельке).  Бот поможет вам привязать ваши Bitcoin и Byteball адреса путём проведения микроплатежа, либо подписания сообщения.</p>
						...
						<p>Первый раунд распределения прошёл 25 декабря 2016 при запуске сети, было привязано более 70 000 BTC, и розданы 10% всего количества байтов и чёрных байтов.  При последующих раундах общий объём распределения достиг 52.6%:</p>
						<ul>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<a class='exchange-icon' href="https://bittrex.com/Market/Index?MarketName=BTC-GBYTE" target="_blank"><img src="https://bittrex.com/Content/img/logos/bittrex-logo-transparent.png" alt="Bitrex"></a>
