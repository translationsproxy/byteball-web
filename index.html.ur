...
<body class="no-trans">
 ...
 فنڈز کے مشترکہ کنٹرول کے لۓ، مختلف لوگوں سے دستخط کی ضرورت ہوسکتی ہے.</p>
	...
	<div class="section clearfix ">
		<div class="container">
			<div class="row">
				<p class="lead text-center">نیکسٹ فری ڈسٹربیوشن (تنتتیوے) <span id="distDate">تاریخ<0/></p>
				<div class="clock row">
						...
						<div class="countdown-time-value clock-item clock-days">
							<div class="wrap">
								<div class="inner">
									...
									<div class="text">
										<p class="val">0</p>
										<p class="type-days type-time">دن</p>
									</div>
									<!-- /.text -->
								</div>
								<!-- /.inner -->
						...
						<div class="clock-item clock-hours countdown-time-value">
							<div class="wrap">
								<div class="inner">
									...
									<div class="text">
										<p class="val">0</p>
										<p class="type-hours type-time">گنٹے</p>
									</div>
									<!-- /.text -->
								</div>
								<!-- /.inner -->
						...
						<div class="clock-item clock-minutes countdown-time-value">
							<div class="wrap">
								<div class="inner">
									...
									<div class="text">
										<p class="val">0</p>
										<p class="type-minutes type-time">منٹ</p>
									</div>
									<!-- /.text -->
								</div>
								<!-- /.inner -->
						...
						<div class="clock-item clock-seconds countdown-time-value">
							<div class="wrap">
								<div class="inner">
									...
									<div class="text">
										<p class="val">0</p>
										<p class="type-seconds type-time">سکنٹس</p>
									</div>
									<!-- /.text -->
								</div>
								<!-- /.inner -->
...
<a href="https://medium.com/byteball/making-p2p-great-again-fe9e20546a4a" target="_blank">پابند (مشروط) ادائیگیوں</a>کا استعمال کرتے ہوئے۔</p>
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<a class='exchange-icon' href="https://bittrex.com/Market/Index?MarketName=BTC-GBYTE" target="_blank"><img src="https://bittrex.com/Content/img/logos/bittrex-logo-transparent.png" alt="بیٹرکس"></a>
					...
					<a class='exchange-icon' href="https://cryptochangex.com" target="_blank"><img src="img/exchanges/cryptochangex.png" alt="کرپٹوچینجکس"></a>
				</div>
			</div>
		</div>
	</div>
