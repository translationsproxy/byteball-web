...
<head>
	<meta charset="utf-8">
	<meta name="description" content="سماٹ ادائیگیوں کو سادہ بنایا۔">
	<meta name="author" content="Byteball">
	<link rel="icon" href="img/icon_16x16@2x.png">

	<title>بیتبال اور ایم ڈیش؛ہوشیار ادائیگیوں کو سادہ بنایا</title>
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse scrollspy smooth-scroll" id="navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li><a href="#why">کیوں</a></li>
								<li><a href="#core">خصوصیات</a></li>
								<li><a href="#download">ڈاؤن لوڈ کریں</a></li>
								<li><a href="#dist">ڈسٹربیوشن</a></li>
								<li><a href="#tech">ٹیکنولوجی</a></li>
								<li><a href="https://wiki.byteball.org" target="_blank" title="ویکی">ویکی</a></li>
								<li><a href="https://twitter.com/ByteballOrg" target="_blank" title="ٹویٹر"><i class="fa fa-twitter"></i></a></li>
								<li><a href="https://www.facebook.com/byteball.org" target="_blank" title="فیس بک"><i class="fa fa-facebook"></i></a></li>
								<li><a href="https://bitcointalk.org/index.php?topic=1608859.0" target="_blank" title="بیٹکوینٹیک دھاگے۔"><i class="fa fa-bitcoin"></i></a></li>
								<li><a href="https://medium.com/byteball" target="_blank" title="درمیانہ بلاگ"><i class="fa fa-medium"></i></a></li>
								<li><a href="https://slack.byteball.org" target="_blank" title="سلیک"><i class="fa fa-slack"></i></a></li>
			...
			<div class="container">
				...
				<div class="row smooth-scroll">
					...
					<div class="row text-center">
						<h2>سماٹ ادائیگیوں کو سادہ بنایا۔</h2>
 ...
 فنڈز کے مشترکہ کنٹرول کے لۓ، مختلف لوگوں سے دستخط کی ضرورت ہوسکتی ہے.</p>
	...
	<div class="default-bg">
		<div id="dist" class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<h2 class="text-center">مناسب ابتدائی تقسیم</h2>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="row margin-zero">
						...
						<ul>
							<li><a href="https://medium.com/byteball/byteball-cashback-program-9c717b8d3173" target="_blank">Cashback</a> for purchases at the merchant stores we partner with.  زیادہ تر مقدمات میں، پیشکش کیش بیک خریداری کی رقم کا 10 فیصد ہوتا ہے۔  <a href="https://medium.com/byteball/byteball-cashback-program-9c717b8d3173" target="_blank">درخواست فارم کو بھریں<0/> یا <script>دستاویز('<a href="mailto:byteball'); document.write('@'); document.write('byteball.org">')؛ <script>ہم سے رابطہ کریں<1/>دستاویز('<2>') ؛ <1/> اگر آپ ایک اسٹور یا ادائیگی پروسیسر چلاتے ہیں اور کیش بیک پروگرام کا حصہ بننا چاہتے ہے۔</li>
						...
						<p>In the past, we also distributed Bytes to BTC holders and existing holders of Bytes.  Users used to link their BTC and Byteball addresses and were receiving new Bytes in proportion to their existing balances in BTC and Bytes.  This distribution was split into several rounds.  نیٹ ورک کا آغاز  25 دسمبر2016 کو ہوا اور پہلی تقسیم کا دورہ ہوا،70،000 سے زائد بی ٹی سی سے منسلک کیا گیا تھا،اور 10٪ بائٹ اور بلب بائٹس کی فراہمی میں تقسیم کیا گیا تھا.  In the subsequent rounds, the total distributed supply reached 64.5%:</p>
						<ul>
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="row margin-zero">
						...
						<p>Join Byteball on <a href="https://slack.byteball.org" target="_blank" title="Slack">Slack</a>! بہت سے چینلز  مستقبل کی ترقی، تجارتی، نیلامی،کے بارے میں متعدد مشورہ کرتے رہتے ہے  صرف چند نام کے نام لیتا ہوں. If you have any issues with the Byteball wallet, our competent support staff will take care of
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<a class='exchange-icon' href="https://bittrex.com/Market/Index?MarketName=BTC-GBYTE" target="_blank"><img src="img/exchanges/bittrex-logo-white-no-tagline.png" alt="بیٹرکس"></a>
					<a class='exchange-icon' style='margin-bottom: 6px;' href="https://cryptox.pl" target="_blank"><img src="https://cryptox.pl/images/logo.png" alt="کرپٹوکس"></a>
					<a class='exchange-icon' href="https://www.cryptopia.co.nz/Exchange/?market=GBYTE_BTC" target="_blank"><img src="img/exchanges/Cryptopia-Light2x.png" alt="کروپٹوپیا"></a>
					...
					<a class='exchange-icon' href="https://bitsquare.io" target="_blank"><img src="img/exchanges/bitsquare.png" alt="بیٹسکور"></a>
					<a class='exchange-icon' style='margin-bottom: 12px;' href="https://www.kaiserex.com" target="_blank"><img src="img/exchanges/kaiserex-logo.png" alt="کیسریکس"></a>
	...
	<footer class="footer text-center">
		...
		<a href="https://www.facebook.com/byteball.org" target="_blank" title="فیس بک"><i class="fa fa-facebook"></i></a> &nbsp;
		<a href="https://bitcointalk.org/index.php?topic=1608859.0" target="_blank" title="بیٹکوینٹیک دھاگے۔"><i class="fa fa-bitcoin"></i></a>		&nbsp;
		<a href="https://medium.com/byteball" target="_blank" title="درمیانہ"><i class="fa fa-medium"></i></a> &nbsp;
		<a href="https://slack.byteball.org" target="_blank" title="سلیک"><i class="fa fa-slack"></i></a> &nbsp;
