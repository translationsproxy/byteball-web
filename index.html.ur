			...
			<div class="row bg-gray-50">
				<div class="col-lg-12 distibution-desc-div-padding">
					...
					<p class="distribution-text2">
						-  <a href="https://medium.com/obyte/byteball-cashback-program-9c717b8d3173" target="_blank">Cashback</a> for purchases at the merchant stores we partner with. زیادہ تر مقدمات میں، پیشکش کیش بیک خریداری کی رقم کا 10 فیصد ہوتا ہے۔
			...
			<div class="row justify-content-md-center">
				<div class="col-md-12">
					...
					<div class="learn-more-block medium2_img">
						...
						<h3 class="section-heading section-heading--center section-heading--dark noto-sans-display-regular after-before-delete learn-more-desc">The 4 articles below are an excellent introduction to O<sub>byte</sub> (formerly Byteball). The articles use graphics, video and are written in easy to understand language. We suggest starting here for most people that are new to O<sub>byte</sub>.</h3>
					...
					<div class="learn-more-block whitepaper_img" style="display:none;">
						<h3 class="section-heading section-heading--center section-heading--dark noto-sans-display-regular after-before-delete learn-more-desc">The O<sub>byte</sub> whitepaper is very detailed and quite technical. If you are not a developer or do not have a technical mind you may struggle to understand it. If so we suggest reading some of the 4 introduction articles listed above. However if you have a technical mind by all means read the whitepaper! It was written by Tony Churyumoff, the O<sub>byte</sub> founder, and is the single most comprehensive resource on O<sub>byte</sub> that exists.</h3>
					</div>
					<div class="learn-more-block wiki_img" style="display:none;">
						<h3 class="section-heading section-heading--center section-heading--dark noto-sans-display-regular after-before-delete learn-more-desc">The wiki is an excellent resource with articles on a wide range of features of the O<sub>byte</sub> platform. However there is a lot of information and you may feel a bit lost! If you are totally new to O<sub>byte</sub> we suggest reading the 4 articles listed below. If you read the 4 articles and want to learn more (which you will) then explore the wiki.</h3>
					</div>
			...
			<div class="row justify-content-center">
				<div class="col-md-9">
					<p class="text-center section-content-text m-b-50 noto-sans-display-regular after-before-delete" style="color: #666666; font-weight: normal; max-width: 900px;margin-left: auto; margin-right: auto; font-size: 22px;line-height: 1.4;">
						You can buy or sell bytes without leaving the wallet by <a href="byteball:Ar2ukVqx309sX+LoC9RVOpfATgXskt+Ser5jVr3Q2FOo@obyte.org/bb#0000">chatting with a trading bot</a>. You can also trade on the exchanges listed below.
						<br><br>
