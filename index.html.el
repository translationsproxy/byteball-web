		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-5 margin-left-7p">
					<h3 class="section-heading m-b-30 block2-title-margin-top open-sans-bold">ICO Πλατφόρμα</h3>
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<div class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse11" aria-expanded="false" aria-controls="collapse11">
								...
								<span class="iconbox-text iconbox-text-100 open-sans-regular">Η μοναδική ICO πλατφόρμα της αγοράς που προσφέρει τη δυνατότητα αυτοματοποιημένων συμμορφούμενων πωλήσεων νομισμάτων ασφαλείας.</span>
							</div>
						</li>
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
				...
				<div class="col-md-5 margin-left-7p">
					...
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						...
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<div class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse22" aria-expanded="false" aria-controls="collapse22">
								<i class="iconbox-icon" style="background: none !important;border: none !important;box-shadow: none !important;"></i>
								<span class="iconbox-text iconbox-text-100 open-sans-regular">Μπορείτε να θέσετε μια προϋπόθεση για τη στιγμή που ο δικαιούχος λαμβάνει τα χρήματα. Αν η προϋπόθεση δεν πληρούται, σας επιστρέφονται τα χρήματά σας.</span>
							</div>
						</li>
					</ul>
				</div>
						...
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<div class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse22" aria-expanded="false" aria-controls="collapse22">
								...
								<span class="iconbox-text iconbox-text-100 open-sans-regular"> Βρείτε το ομόλογό σας στο <a href="https://byteball.slack.com/messages/C4UMVU4QZ/" target="_blank">#prediction_markets</a> κανάλι στο <a href="https://slack.byteball.org" target="_blank" title="Slack">Slack</a> μας και δημιουργήστε ένα συμβόλαιο που να αποδεσμεύεται από εσάς ή από τους ομότιμούς σας ανάλογα με τα αποτελέσματα κάποιου μελλοντικού παιχνιδιού.<br><br>
                                                                         Έπειτα από τη γνωστοποίηση του αποτελέσματος, <a href="byteball:Ar1O7dGgkkcABYNAbShlY2Pbx6LmUzoyRh6F14vM0vTZ@byteball.org/bb#0000">επικοινωνήστε με την sports oracle μέσω chat </a> προκειμένου να αναρτηθούν τα δεδομένα σχετικά με το αποτέλεσμα, στη συνέχεια μπορείτε να αποδεσμεύσετε το συμβόλαιο.
							</div>
						</li>
					</ul>
				</div>
