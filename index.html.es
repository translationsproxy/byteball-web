...
<body class="no-animsition">
						...
						<li class="language-nav-item">
							<div class="btn-group">
								...
								<ul class="dropdown-menu language-block" role="menu">
									...
									<li><a href="index.html.zh" class="language"> <img src="static/images/flags/china.png" alt="Chino" class="img-thumbnail icon-medium"></a></li>
									...
									<li><a href="index.html.nl" class="language"><img src="static/images/flags/netherlands.png" alt="Neerlandés" class="img-thumbnail icon-medium"></a></li>
									...
									<li><a href="index.html.de" class="language"><img src="static/images/flags/germany.png" alt="Alemán" class="img-thumbnail icon-medium"></a></li>
									<li><a href="index.html.ja" class="language"><img src="static/images/flags/japan.png" alt="Japonés" class="img-thumbnail icon-medium"></a></li>
									<li><a href="index.html.es" class="language"><img src="static/images/flags/spain.png" alt="Español" class="img-thumbnail icon-medium"></a></li>
									<li><a href="index.html.fr" class="language"><img src="static/images/flags/france.png" alt="Francés" class="img-thumbnail icon-medium"></a></li>
									<li><a href="index.html.id" class="language"><img src="static/images/flags/indonesia.png" alt="Indonesio" class="img-thumbnail icon-medium"></a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-6 col-md-push-6 text-center text-md-left order-md-2">
					...
					<p><button id="openInApp" class="btn btn-lg btn-success m10" style="cursor: pointer">Recibir fondos</button></p>
					<p>
					...
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						...
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<div class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse22" aria-expanded="false" aria-controls="collapse22">
								<i class="iconbox-icon" style="background: none !important;border: none !important;box-shadow: none !important;"></i>
								<span class="iconbox-text iconbox-text-100 open-sans-regular">
									Create a P2P smart contract that can be unlocked if a specific event occurs. Utilícelo para <a href="https://medium.com/byteball/making-p2p-great-again-episode-iii-prediction-markets-f40d49c0abab"
								 target="_blank">apostar en movimientos de precios</a>, apuestas deportivas y seguros.                                    <br><br>
					...
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						...
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<div class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse22" aria-expanded="false" aria-controls="collapse22">
								<i class="iconbox-icon" style="background: none !important;border: none !important;box-shadow: none !important;"></i>
								<span class="iconbox-text iconbox-text-100 open-sans-regular">
									The sender just writes an email address where he would normally write a Byteball address. El receptor hace clic en el enlace recibido por email o chat. Si el destinatario aún no está en Byteball, se le pedirá que instale el monedero. En Android, la instalación comienza automáticamente. <a href="https://medium.com/byteball/sending-cryptocurrency-to-email-5c9bce22b8a9" target="_blank">Aprenda más</a>.                                </span>
							</div>
						</li>
					</ul>
				</div>
					...
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						...
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<div class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse22" aria-expanded="false" aria-controls="collapse22">
								<i class="iconbox-icon" style="background: none !important;border: none !important;box-shadow: none !important;"></i>
								<span class="iconbox-text iconbox-text-100 open-sans-regular">
									Have your real identity verified and securely stored in your wallet. <a href="https://www.jumio.com/" target="_blank">Jumio</a> facilita la verificación de ID. Cuando quiera revelar su identidad a un proveedor de servicios, p. ej. para participar en una ICO, puede obtenerlo de su monedero en unos pocos clicks. <a href="https://medium.com/byteball/bringing-identity-to-crypto-b35964feee8e" target="_blank">Aprenda más</a>.                                </span>
							</div>
						</li>
					</ul>
				</div>
			...
			<div class="row bg-gray-50">
				<div class="col-lg-12 distibution-desc-div-padding">
					<h3 class="m-b-40 distribution-text">
						...
						<br><br>The first distribution round took place on Dec 25, 2016 when the network launched, over 70,000 BTC was linked, and 10% of the total supply of bytes and blackbytes was distributed. En las rondas posteriores, el total distribuido llegó a 64.5%:                    </h3>
	...
	<section class="section section-partner bg-white p-t-10 p-b-100">
		<div class="container">
			...
			<h3 class="section-heading section-heading--center m-b-45 distribution-title">Casas de cambio</h3>
			<div class="row justify-content-center">
				<div class="col-md-9">
					<p class="text-center section-content-text m-b-50 noto-sans-display-regular after-before-delete" style="color: #666666; font-weight: normal; max-width: 900px;margin-left: auto; margin-right: auto; font-size: 22px;line-height: 1.4;">
						Puedes comprar o vender bytes sin salir de la billetera por <a href="byteball:Ar2ukVqx309sX+LoC9RVOpfATgXskt+Ser5jVr3Q2FOo@byteball.org/bb#0000">chatear con un bot de intercambio</a>. También puede intercambiar en las casas de cambio listadas a continuación.
						<br><br>
