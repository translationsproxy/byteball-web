				...
				<div class="col-md-5 margin-left-7p">
					...
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						...
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<div class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse22" aria-expanded="false" aria-controls="collapse22">
								<i class="iconbox-icon" style="background: none !important;border: none !important;box-shadow: none !important;"></i>
								<span class="iconbox-text iconbox-text-100 open-sans-regular">The sender just writes an email address where he would normally write an O<sub>byte</sub> address. El receptor hace clic en el enlace recibido por email o chat. If the recipient is not in O<sub>byte</sub> yet, he will be prompted to install the wallet. En Android, la instalación comienza automáticamente. <a href="https://medium.com/obyte/sending-cryptocurrency-to-email-5c9bce22b8a9" target="_blank">Learn more</a>.</span>
							</div>
						</li>
					</ul>
				</div>
				...
				<div class="col-md-5 margin-left-7p">
					...
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						...
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<div class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse22" aria-expanded="false" aria-controls="collapse22">
								<i class="iconbox-icon" style="background: none !important;border: none !important;box-shadow: none !important;"></i>
								<span class="iconbox-text iconbox-text-100 open-sans-regular">Have your real identity verified and securely stored in your wallet. <a href="https://www.jumio.com/" target="_blank">Jumio</a> facilita la verificación de ID. Cuando quiera revelar su identidad a un proveedor de servicios, p. ej. para participar en una ICO, puede obtenerlo de su monedero en unos pocos clicks. <a href="https://medium.com/obyte/bringing-identity-to-crypto-b35964feee8e" target="_blank">Learn more</a>.</span>
							</div>
						</li>
					</ul>
				</div>
			...
			<div class="row bg-gray-50">
				<div class="col-lg-12 distibution-desc-div-padding">
					...
					<p class="distribution-text2">
						-  <a href="https://medium.com/obyte/byteball-cashback-program-9c717b8d3173" target="_blank">Cashback</a> for purchases at the merchant stores we partner with. En la mayoría de los casos, la devolución de dinero ofrecida es el 10% del monto de la compra.
			...
			<div class="row bg-gray-50">
				<div class="col-lg-12 distibution-desc-div-padding">
					<h3 class="m-b-40 distribution-text">
						En el pasado, también se distribuyeron Bytes a poseedores de BTC y Bytes. Users used to link their BTC and O<sub>byte</sub> addresses and were receiving new Bytes in proportion to their existing balances in BTC and Bytes. Esta distribución se dividió en varias rondas.
